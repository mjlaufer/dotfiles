# Generated by Powerlevel10k configuration wizard on 2026-07-11 at 00:24 PDT.
...
() {
  ...
  # Default prompt symbol. Also styles the transient prompt: directory, timestamp,
  # and a $ whose color tracks the last exit status.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%F{4}%~ %F{8}%D{%H:%M:%S} %F{2}$'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{4}%~ %F{8}%D{%H:%M:%S} %F{1}$'
